...
caminho_arquivo = '/projects/pi.samanta.xavier/proj.lucas.leonardo/proj.mestrado/3km_mass_idade/3km_mass_idade_correlacao.xlsx'
...
def load_dataset(caminho_arquivo):
    col_names = [
        'Animal_infectado', 'Sexo_binary', 'Faixa_etaria', 'Body_mass', 'LAT', 'Alpha_fisher',
        'Menhinick', 'Splitting_index_1', 'variation_fractal_dimension_index_1', 'edge_density_14',
        'variation_of_euclidean_nearest.neighbor_distance_14', 'variation_fractal_dimension_index_14', 'patch_density_22',
        'variation_of_euclidean_nearest.neighbor_distance_22', 'Like.Adjacencies_22', 'Splitting_index_22',
        'Effective_mesh_size_22', 'variation_fractal_dimension_index_22', 'bio_1', 'bio_18', 'bio_19', 'bio_2', 'bio_3'

    ]
    dataset = pd.read_excel(caminho_arquivo, names=col_names).dropna()
    feature_names = [
        'Sexo_binary', 'Faixa_etaria', 'Body_mass', 'LAT', 'Alpha_fisher',
        'Menhinick', 'Splitting_index_1', 'variation_fractal_dimension_index_1', 'edge_density_14',
        'variation_of_euclidean_nearest.neighbor_distance_14', 'variation_fractal_dimension_index_14', 'patch_density_22',
        'variation_of_euclidean_nearest.neighbor_distance_22', 'Like.Adjacencies_22', 'Splitting_index_22',
        'Effective_mesh_size_22', 'variation_fractal_dimension_index_22', 'bio_1', 'bio_18', 'bio_19', 'bio_2', 'bio_3'
...
save_model(trained_best_model, '3km_mass_idade.pickle')
